---
active: true
description: "LLM-as-reranker — scores retrieved profiles for query relevance using world knowledge. v1.1.0 cleans benchmark-specific brand examples from v1.0.0; behaviour is unchanged (brand→category and tool→use-case bridging)."
variables:
  - query
  - docs_block
  - num_docs
