...
changelog: "v4.1.5: adds resumable extraction guidance, keeps recipes for representation-changing fixes with semantic constraints, and avoids a polarity output field."
variables:
