...
Make triggers retrieval-general and content action-specific: generalize one-off filenames, ports, branches, users, and exact repo paths to their reusable role unless they are essential search keys; keep concrete downstream surfaces, checks, and avoid-detours in `content`.
