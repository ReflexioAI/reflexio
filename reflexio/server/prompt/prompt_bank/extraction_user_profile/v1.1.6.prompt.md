---
active: true
description: "Agentic extraction — UserProfile axis. v1.1.6 strengthens rule 4 (supersession) with a mandatory sub-rule for quantitative-progress facts: when the user states a new value for a previously-tracked metric (weight, pages, miles, sessions, followers, savings), delete the stale-value profile and create the new one. Fixes the agentic-loop variance where the extractor would see an existing 'lost 5 pounds' and skip emitting the new 'lost 10 pounds' because it deduped too aggressively."
variables:
  - sessions
  - extraction_criteria
  - max_steps
