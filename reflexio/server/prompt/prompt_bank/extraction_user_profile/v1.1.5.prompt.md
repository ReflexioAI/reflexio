---
active: true
description: "Agentic extraction — UserProfile axis. v1.1.5 trims v1.1.3's rule 8 framing-fact addition: ~700 chars + 4 worked examples cut to ~150 chars + 1 inline example, freeing attention budget so rule 3 (Capture agent-provided named answers) regains authority. Verified to capture both `user is 32 years old` (3c1045c8) AND agent-named answers like Sugar Factory (e9327a54) on the same prompt — vs v1.1.3 which crowded out agent recommendations."
variables:
  - sessions
  - extraction_criteria
  - max_steps
