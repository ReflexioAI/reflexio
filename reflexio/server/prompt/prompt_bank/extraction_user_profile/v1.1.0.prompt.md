---
active: false
description: "Agentic extraction — UserProfile axis. v1.1.0 strengthens rule 9 with explicit named-place-visit/named-event-attended examples — fixes failures where extraction collapsed multiple museum/property visits into a single user-interest fact."
variables:
  - sessions
  - extraction_criteria
  - max_steps
