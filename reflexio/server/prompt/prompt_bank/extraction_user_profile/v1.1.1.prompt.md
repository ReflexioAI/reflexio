---
active: false
description: "Agentic extraction — UserProfile axis. v1.1.1 adds rule 10: \"started X\" and \"finished X\" are SEPARATE events with separate dates — do not dedupe across them. Fixes T-R duration failures where extraction kept only the start event."
variables:
  - sessions
  - extraction_criteria
  - max_steps
