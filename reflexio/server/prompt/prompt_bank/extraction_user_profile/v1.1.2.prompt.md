---
active: true
description: "Agentic extraction — UserProfile axis. v1.1.2 adds explicit \"today\"/\"just finished/started\" → session_date resolution example to rule 4 — fixes failures where extraction left implicit-today phrases in content without ISO date."
variables:
  - sessions
  - extraction_criteria
  - max_steps
