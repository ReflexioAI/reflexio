---
active: false
description: "Agentic extraction — UserProfile axis. v1.1.2 adds explicit \"today\"/\"just finished/started\" → session_date resolution example to rule 4 — fixes failures where extraction left implicit-today phrases in content without ISO date. Superseded by v1.1.3."
variables:
  - sessions
  - extraction_criteria
  - max_steps
