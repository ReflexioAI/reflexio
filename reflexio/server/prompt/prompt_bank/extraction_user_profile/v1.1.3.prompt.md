---
active: true
description: "Agentic extraction — UserProfile axis. v1.1.3 strengthens demographic and quantitative-context capture: when the user volunteers a specific number or attribute about themselves, their family, or their environment (their own age, family-member ages, department/team metrics, salary, height, kids/pets count) as conversational FRAMING for a different topic, capture it. Fixes failures where extraction skipped 'I'm 32 years old' or 'avg age in my dept is 29.5' because the session was about an unrelated topic (skincare, master's programs)."
variables:
  - sessions
  - extraction_criteria
  - max_steps
