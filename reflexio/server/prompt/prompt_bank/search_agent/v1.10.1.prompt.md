---
active: true
description: "Agentic search — orchestration patterns + cross-encoder rerank + LLM rerank for brand→category gaps + storage_stats; reads only. v1.10.1 raises Pattern D session_id cap from 4 to 6 to handle larger counting enumerations."
variables:
  - query
  - max_steps
  - enable_agent_answer
