---
active: true
description: "Agentic search — orchestration patterns + cross-encoder rerank + LLM rerank + storage_stats; reads only. v1.10.2 widens Pattern F llm_rerank exception from superlative-within-category-only to total/sum-across-category as well (covers 'how much spent on bike-related expenses' style sums where operands phrased as 'bought/got/spent X for $Y' need bridging to 'expenses')."
variables:
  - query
  - max_steps
  - enable_agent_answer
