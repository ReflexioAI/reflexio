---
active: true
description: "Agentic search — orchestration patterns + cross-encoder rerank + LLM rerank + storage_stats; reads only. v1.10.1 was net-negative on tune-100 (r106-r109); v1.10.0 is the locked baseline."
variables:
  - query
  - max_steps
  - enable_agent_answer
