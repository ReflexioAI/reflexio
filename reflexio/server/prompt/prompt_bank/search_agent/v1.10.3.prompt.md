---
active: true
description: "Agentic search — orchestration patterns + cross-encoder rerank + LLM rerank + storage_stats; reads only. v1.10.3 cleans benchmark-specific brand examples and removes 'wrong on this benchmark' phrasing from v1.10.2; the Pattern F llm_rerank widen for total-over-category sums is preserved with abstract example shapes."
variables:
  - query
  - max_steps
  - enable_agent_answer
