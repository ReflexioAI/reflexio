---
active: true
description: "Answer-LLM system prompt for the longmemeval benchmark. v1.5.0 adds rule 15 (category-superlative date-window leniency — when the question is 'which [category] did I do the most/least at in the past [time-period]', do NOT exclude candidates with strict day-counting; treat 'past month'/'recently'/'lately' as inclusive of the recent few weeks and compare ALL retrieved candidates by the superlative criterion)."
variables: []
---
