---
active: true
description: "Answer-LLM system prompt for the longmemeval benchmark — composes a final hypothesis from retrieved profiles + rehydrated session excerpts. Has no template variables; the question and context are passed as the user message."
variables: []
---
