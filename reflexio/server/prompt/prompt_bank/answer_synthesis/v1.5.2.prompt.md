---
active: false
description: "Answer-LLM system prompt for memory-grounded user questions. v1.5.2 deep-scrubs benchmark-specific examples from rules 12 (Cedar Creek property) and 13 (Tokyo airport, NovaTech, Google) inherited from v1.5.0, replacing them with abstract <PLACEHOLDER> shapes."
variables: []
---
