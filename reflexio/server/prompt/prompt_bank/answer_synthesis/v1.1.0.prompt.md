---
active: false
description: "Answer-LLM system prompt for the longmemeval benchmark — composes a final hypothesis from retrieved profiles + rehydrated session excerpts. v1.1.0 adds an action-decomposition rule (rule 9): for counting questions about ACTIONS (pickup/return/visit/attend/etc.), count each distinct action separately even if the same physical entity is involved. Fixes 0a995998-style failures where exchanges were counted as 1 item instead of return + pickup = 2 actions."
variables: []
---
