---
active: true
description: "Answer-LLM system prompt for the longmemeval benchmark. v1.4.0 adds rule 14 (time-anchored instance disambiguation — when the question references an event with a temporal specifier, anchor on the target date FIRST, then check attributes — do not pick a different-date instance because it has the asked-about attribute)."
variables: []
---
