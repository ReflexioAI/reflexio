---
active: true
description: "Answer-LLM system prompt for memory-grounded user questions. v1.5.1 cleans the prior version's benchmark-specific framing from the description (no body change vs v1.5.0)."
variables: []
---
