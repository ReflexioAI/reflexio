---
active: true
description: "Answer-LLM system prompt for the longmemeval benchmark — composes a final hypothesis from retrieved profiles + rehydrated session excerpts. v1.2.0 adds rules 11 (multi-iteration artifact recall — use the LAST iteration when an artifact was regenerated) and 12 (instance disambiguation — match question specifiers to the right instance when multiple candidates appear)."
variables: []
---
