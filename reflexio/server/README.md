...
| `logs_api.py` | `/api/logs` local structured log retrieval for OSS operator dashboards |
...
- **Batch generation control**: `GET /api/get_operation_status`, `POST /api/cancel_operation`
...
- **Service operations**: `GET /api/logs`, `POST /api/admin/cache/invalidate`
- **Admin/data management**: `DELETE /api/delete_interaction`, `DELETE /api/delete_request`, `DELETE /api/delete_session`, `DELETE /api/delete_requests_by_ids`, `DELETE /api/delete_all_interactions`, `POST /api/clear_user_data`
