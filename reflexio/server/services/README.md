...
| `reflection/` | `ReflectionService` | `reflection_service.py`, `reflection_extractor.py` — post-horizon reflection; runs **before** extraction so extractors read post-reflection state |
