...
| `agent_success_evaluation/` | `AgentSuccessEvaluationService` | `components/evaluator.py` (session-level), `scheduler.py` (`GroupEvaluationScheduler`, 10-min defer), `runner.py`, `regen_jobs.py` |
