...
| `search_observer.py` | Optional best-effort observer of final successful unified searches; carries correlation and learning IDs without response content. Observer failure leaves retrieval successful. |
