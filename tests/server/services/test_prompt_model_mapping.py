...
PROMPT_VERSION_MAP: dict[str, tuple[str, str | None]] = {
    ...
    "playbook_extraction_context": ("v2.0.0", None),
    "playbook_extraction_context_incremental": ("v2.0.0", None),
    "playbook_should_generate": ("v1.0.0", "boolean_evaluation"),
    "playbook_should_generate_expert": ("v1.0.0", "boolean_evaluation"),
    "playbook_extraction_context_expert": ("v2.0.0", None),
    "playbook_extraction_main_expert": ("v1.0.0", "playbook_extraction"),
    "playbook_aggregation": ("v1.0.0", "playbook_aggregation"),
    "playbook_deduplication": ("v1.0.0", "playbook_deduplication"),
