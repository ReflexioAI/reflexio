...
PROMPT_VERSION_MAP: dict[str, tuple[str, str | None]] = {
    ...
    "playbook_offline_edit": ("v1.0.0", "offline_tuner_corrective_proposer"),
    "playbook_offline_generative": ("v1.0.0", "offline_tuner_generative_proposer"),
    "playbook_offline_judge": ("v1.0.0", "offline_tuner_pairwise_judge"),
    "playbook_adoption_judge": ("v1.0.0", "offline_tuner_mode_b_adoption_judge"),
    "playbook_success_label_self_consistency": (
        "v1.0.0",
        "offline_tuner_success_label_self_consistency",
    ),
